...
<!--
    ...
    <div class="col-xs-12 col-md-4">
		<button class="btn btn-block btn-warning">
			<a href="/aktsii-skidki/85-aktsii-dlya-yuridicheskikh-lits-i-ip" >Акционные товары<br />
		<br />
		<sub>предложение акционных товаров </sub></a>
<br />
		</button>
<br />
	</div>	
...
<!--
<h3>Уважаемые партнёры!</h3>
<p class="payable"><span class="AccountValue">1 июля 2022 года на нашем складе проводится инвентаризация товаров (аккумуляторов). Актуальный остаток будет доступен после 14:30.</span></p>
-->
...
<p class="payable">Специальные цены на аккумуляторы <a href="https://bat.by/catalog/filter/akom/?custom_f_18[0]=427261766f&custom_f_4[0]=190&custom_f_4[1]=190">BRAVO 190</a>, цена <span class="AccountValue"> 349,00 BYN с НДС</span>, вне зависимости от вашей скидки!</p>
<p></p>
