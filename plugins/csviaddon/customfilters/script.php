...
/**
 * Custom Filters addon installer.
 *
 * @package     CSVI
 * @subpackage  Customfilters
 * @since       6.0
 */
class PlgcsviaddoncustomfiltersInstallerScript
{
	/**
	...
	public function postflight($parent)
	{
		...
		{
			// Load the tasks
			$queries = $db->splitSql(file_get_contents(JPATH_PLUGINS . '/csviaddon/customfilters/com_customfilters/install/tasks.sql'));
