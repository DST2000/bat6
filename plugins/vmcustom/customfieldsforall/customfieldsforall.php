...
require_once(JPATH_PLUGINS.DIRECTORY_SEPARATOR.'vmcustom'.DIRECTORY_SEPARATOR.'customfieldsforall'.DIRECTORY_SEPARATOR.'helpers'.DIRECTORY_SEPARATOR.'update.php');
...
class plgVmCustomCustomfieldsforall extends vmCustomPlugin
{
	...
	/**
	 * (non-PHPdoc)
	 * @see vmPlugin::onStoreInstallPluginTable()
	 */
	 ...
	 * @since	1.0
	 */
	private function storeAllCustomsforall($data,$custom_plugins,$single_assignment=null)
	{
		...
		$result=Customfield::deleteProductValues($product_id,$all_values);
