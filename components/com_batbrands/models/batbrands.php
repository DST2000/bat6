...
/**
 * Batbrands model for the Joomla Batbrands component.
 *
 * @since  1.6
 */
class BatbrandsModelBatbrands extends JModelList
{
	/**
	...
	protected function getListQuery()
	{
		...
		$query->select(
			'a.id as id,'
				...
				. 'a.image_big_alt as image_big_alt,'
				. 'a.image_small as image_small,'
				. 'a.image_small_alt as image_small_alt,'
				. 'a.header_title as header_title,'
				. 'a.background_color as background_color,'
				. 'a.header_text as header_text,'
				. 'a.middle_text as middle_text,'
				. 'a.footer_text as footer_text,'
				. 'a.params as params,'
				. 'a.custombatbrandcode as custombatbrandcode,'
				. 'a.track_impressions as track_impressions,'
				. 'cl.track_impressions as client_track_impressions'
		)
			->from('#__batbrands as a')
	...
	/**
	 * Makes impressions on a list of batbrands
	 *
	 * @return  void
	 *
	 * @since   1.6
