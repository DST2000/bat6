...
$this->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/style-newmenu.css?v=6');
...
$this->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/layout.css?v=5', 'text/css', 'screen');
