...
$this->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/style.css?v=64');
$this->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/style-newmenu.css?v=101');
