...
$this->addStyleSheet($this->baseurl . '/templates/' . $this->template . '/css/style-newmenu.css?v=98');
...
$this->addScript($this->baseurl . '/templates/' . $this->template . '/js/scripts.js?v=35');
