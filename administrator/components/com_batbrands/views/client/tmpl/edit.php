...
<form action="<?php echo JRoute::_('index.php?option=com_batbrands&layout=edit&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="client-form" class="form-validate">
	...
	<div class="form-horizontal">
		...
		<?php echo JHtml::_('bootstrap.addTab', 'myTab', 'general', empty($this->item->id) ? JText::_('COM_BATBRANDS_NEW_CLIENT') : JText::_('COM_BATBRANDS_EDIT_CLIENT')); ?>
		<div class="row-fluid">
			<div class="span9">
				<?php
