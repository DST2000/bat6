 ...
 * @since  1.5
 */
class BatbrandsViewClient extends JViewLegacy
{
	/**
	 * The JForm object
	 *
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = JHelperContent::getActions('com_batbrands');
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title(
			$isNew ? JText::_('COM_BATBRANDS_MANAGER_CLIENT_NEW') : JText::_('COM_BATBRANDS_MANAGER_CLIENT_EDIT'),
			'bookmark batbrands-clients'
		);
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_batbrands.client', $this->item->id);
			}
		...
		JToolbarHelper::help('JHELP_COMPONENTS_BATBRANDS_CLIENTS_EDIT');
	}
}
