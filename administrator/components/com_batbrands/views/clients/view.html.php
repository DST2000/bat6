 ...
 * @since  1.6
 */
class BatbrandsViewClients extends JViewLegacy
{
	/**
	 * An array of items
	 *
	...
	public function display($tpl = null)
	{
		...
		BatbrandsHelper::addSubmenu('clients');
	...
	{
		$canDo = JHelperContent::getActions('com_batbrands');

		JToolbarHelper::title(JText::_('COM_BATBRANDS_MANAGER_CLIENTS'), 'bookmark batbrands-clients');
		...
		JToolbarHelper::help('JHELP_COMPONENTS_BATBRANDS_CLIENTS');
	}
	...
	protected function getSortFields()
	{
		return array(
			...
			'a.name'      => JText::_('COM_BATBRANDS_HEADING_CLIENT'),
			'contact'     => JText::_('COM_BATBRANDS_HEADING_CONTACT'),
			'client_name' => JText::_('COM_BATBRANDS_HEADING_CLIENT'),
			'nbatbrands'    => JText::_('COM_BATBRANDS_HEADING_ACTIVE'),
