 ...
 * @since  1.5
 */
class BatbrandsModelDownload extends JModelForm
{
	/**
	 * The model context
	 *
	 * @var  string
	 */
	protected $_context = 'com_batbrands.tracks';
	...
	{
		// Get the form.
		$form = $this->loadForm('com_batbrands.download', 'download', array('control' => 'jform', 'load_data' => $loadData));
	...
	protected function loadFormData()
	{
		...
		$this->preprocessData('com_batbrands.download', $data);
