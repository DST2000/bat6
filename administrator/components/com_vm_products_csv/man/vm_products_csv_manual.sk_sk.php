...
$import_label = 'Import Produktov ';
$export_label = 'Export Produktov ';
$page_title_html = 'Dokumentácia pre Joomla Komponent VM Products CSV <span style="color:#204D02;">!ULTIMATE!</span> v3 by <a href="http://www.ekerner.com/" title="Developer website" onclick="window.open(this.href); return false;">ekerner.com</a>';
if ($is_joomla) {
...
echo('
	<div>
		...
		<div style="margin:0 40px;">
			<h3>Menu ...</h3>
			<ul>
				<li><a title="" href="#usage">Používanie</a></li>
				<li><a title="" href="#supported_fields">Podporované polia</a></li>
				<li><a title="" href="#features">Funkcie</a></li>
				<li><a title="" href="#languages">Jazyky</a></li>
				<li><a title="" href="#notes">Poznámky</a></li>
				<li><a title="" href="#screenshots">Ukážky</a></li>
			</ul>
		</div>
		<a name="usage"></a>
		<div style="margin:0 40px;">
