...
class vm_products_csvModelImport_products extends JModelList
{
	public function getProducts()
	{
		...
		{
			$product->url = 'index.php?option=com_vm_products_csv&amp;task=import_products.edit&amp;product_id='.$product->virtuemart_product_id;
		}
		*/
