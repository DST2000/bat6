...
class vm_products_csvViewExport_products extends JViewLegacy
{
	protected $products;
	...
	public function display($tpl = null)
	{
		...
		vm_products_csvUtils::addSubmenu('export_products');
		vm_products_csvUtils::addToolbar('export_products');
